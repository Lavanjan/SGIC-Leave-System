  ...
  return (
    <header class="mdl-layout__header">
        <div class="mdl-layout__header-row">
            {/* <div class="contact-us mdl-layout--large-screen-only">
            ...
            <ul class="mdl-menu mdl-list mdl-js-menu mdl-js-ripple-effect mdl-menu--bottom-right mdl-shadow--2dp messages-dropdown"
                ...
                <li class="mdl-menu__item mdl-list__item mdl-list__item--two-line list__item--border-top">
                    ...
                    <span class="mdl-list__item-secondary-content">
                      <span class="label label--transparent">1 hours</span>
                    </span>
                </li>
                <li class="mdl-menu__item mdl-list__item mdl-list__item--two-line list__item--border-top">
                    <span class="mdl-list__item-primary-content">
            ...
            <div class="avatar-dropdown" id="icon">
                <span>Admin</span>
                <img src="http://creativeit.io/material-dashboard-lite/images/Icon_header.png"/>
            </div>
